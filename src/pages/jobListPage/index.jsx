...
const JobList = () => {
  ...
  const jobState = useSelector((store) => store.jobState);
  ...
  return (
    <>
      ...
      <div className="container">
        <h1>
          {jobState.jobs > jobState.filteredJobs
            ? "Filtrelenmis is Listesi"
            : "Genel Is Listesi"}
        </h1>
        <table>
          <tbody>
            <tr>
              <th>
                <b>
                  <u>Toplam:</u> <span>{jobState.filteredJobs.length}</span>
                </b>
              </th>
              <th>Firma</th>
              <th>Pozisyon</th>
            ...
            {!jobState.initialized ? (
              ...
              jobState.filteredJobs.map((item, index) => (
                <tr
                  key={index}
